    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="{{url('products/update', $article->id)}}" method="post" enctype="multipart/form-data">
                ...
                <button style="margin-top: 20px" type="submit" class="btn btn-primary">Enregistrer les modifications</button>
        </div> <!-- #end col md 6 -->
        ...
        <div class="col-md-6">
            <div class="form-group">
                <div class="input-radio">
                    <h2>Statut</h2>
                    publié <input type="radio" @if($article->statut == 'publié') checked @endif name="statut" value="publié" > 
                    <br>   
                    brouillon <input type="radio" @if($article->statut == 'brouillon') checked @endif name="statut" value="brouillon">
                </div>
            </div>
            ...
            <div style="margin-top: 10px" class="form-select">
                        ...
                        <select id="code" name="code" class="form-control">
                            <option @if($article->code == 'soldes') selected @endif>soldes</option>
